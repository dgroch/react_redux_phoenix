...
/***/ function(module, exports, __webpack_require__) {
	...
	var target = document.getElementById('react_app');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxAct = __webpack_require__(260);
	...
	exports.default = (0, _reduxAct.createReducer)((_createReducer = {}, _defineProperty(_createReducer, actions.sign_in_success, function () {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
	  var payload = arguments[1];

	  return state;
	}), _defineProperty(_createReducer, actions.sign_out_success, function () {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
	  var payload = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var send_password_request = (0, _reduxAct.createAction)('Send password request');
	var send_password_success = (0, _reduxAct.createAction)('Send password success');
	var send_password_error = (0, _reduxAct.createAction)('Send password error');

	var authentication_request = (0, _reduxAct.createAction)('Authentication request');
	var authentication_success = (0, _reduxAct.createAction)('Authentication success');
	var authentication_error = (0, _reduxAct.createAction)('Authentication error');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createAction = __webpack_require__(261);
	...
	var _createReducer = __webpack_require__(263);
	...
	var _assignAll = __webpack_require__(265);
	...
	var _bindAll = __webpack_require__(266);
	...
	var _batch = __webpack_require__(264);
	...
	var _disbatch = __webpack_require__(267);
	...
	var _loggers = __webpack_require__(268);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function configRoutes(store) {
	  return _react2.default.createElement(_reactRouter.Route, { path: '/', component: _main2.default });
	}
